...
public class Page2 extends AppCompatActivity {
    private ImageButton navBtn, gachaBtn;
        ...
        gachaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(point>=0) {
                    ...
                    AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(Page2.this);
                    myAlertBuilder.setTitle("돌아가!");
                    myAlertBuilder.setMessage("가챠를 돌릴 포인트가 부족해요.\n50포인트가 있어야 가챠를 돌릴 수 있어요.");
